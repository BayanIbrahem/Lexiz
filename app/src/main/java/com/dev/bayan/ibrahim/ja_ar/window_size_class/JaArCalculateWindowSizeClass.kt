...
/**
 * **THIS IS A COPY OF [androidx.compose.material3.windowsizeclass.calculateWindowSizeClass]**
...
@Composable
fun jaArCalculateWindowSizeClass(activity: Activity): JaArWindowSizeClass {
    ...
    return JaArWindowSizeClass.calculateFromSize(size)
}
