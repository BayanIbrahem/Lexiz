...
internal fun CategoryEditorScreen(
    ...
    uiActions: CategoryEditorUiActions,
            ...
            JaArContainer(
                ...
                Column(
                    ...
                    EditorAnimatableField(
                        uiState = uiState.wordField,
                        uiActions = uiActions.wordFieldActions,
                        visible = uiState.currentStep == WORD,
    ...
    Column(
        ...
        JaArContainer(type = JaArContainerType.PRIMARY) {
            EditorSteps(
                ...
                currentStep = uiState.currentStep,
                entries = CategoryEditorSteps.entries,
            ...
            JaArContainer(
                ...
                Column(
                    ...
                    when (uiState.currentStep) {
                        ...
                        WORD -> listOf(uiState.wordField.error)
                    }.mapIndexed { i, it ->
            ...
            Column(
                ...
                JaArContainer(
                    ...
                    EditorNextPrevActionButtons(
                        ...
                        stepsCount = CategoryEditorSteps.entries.count(),
                ...
                JaArContainer(
                    ...
                    EditorConfirmCancelActionButtons(
                        confirmable = CategoryEditorSteps.entries.all { uiState.steps[it] == true },
                        spacedBetween = true,
...
private fun NameDescription(
    ...
    currentStep: CategoryEditorSteps,
    uiState: CategoryEditorUiState,
    uiActions: CategoryEditorUiActions,
    screenSize: JaArScreenSize,
) {
